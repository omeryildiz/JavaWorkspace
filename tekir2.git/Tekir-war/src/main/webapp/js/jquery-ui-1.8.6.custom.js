	...
	load: function( index ) {
		...
		this.xhr = $.ajax( $.extend( {}, o.ajaxOptions, {
			...
			success: function( r, s ) {
                                //HAKY : RicFaces html içine bir dolu ıvır zıvır doldurduğu için gelen result içinden inner_content ayıklaıp alınıyor
                                rr = $(r).filter("div#inner_content").html();
				$( self._sanitizeSelector( a.hash ) ).html( rr );
