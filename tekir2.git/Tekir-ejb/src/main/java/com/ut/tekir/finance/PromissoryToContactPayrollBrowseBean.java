...
/**
 * Senet çıkış bordrosu browse bileşenidir.
 * 
 * @author yigit
 */
@Stateful
@Name("promissoryToContactPayrollBrowse")
@Scope(value = ScopeType.SESSION)
public class PromissoryToContactPayrollBrowseBean extends BrowserBase<PromissoryToContactPayroll, PromissoryToContactPayrollFilterModel> implements PromissoryToContactPayrollBrowse<PromissoryToContactPayroll, PromissoryToContactPayrollFilterModel> {

	@In
    CalendarManager calendarManager;

    @Override
    public PromissoryToContactPayrollFilterModel newFilterModel() {
    	PromissoryToContactPayrollFilterModel fm = new PromissoryToContactPayrollFilterModel();
    ...
    @Observer("refreshBrowser:com.ut.tekir.entities.PromissoryToContactPayroll")
