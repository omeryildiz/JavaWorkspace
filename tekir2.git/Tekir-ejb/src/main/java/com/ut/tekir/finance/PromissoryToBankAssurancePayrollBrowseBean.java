 ...
 */
@Stateful
@Name("promissoryToBankAssurancePayrollBrowse")
@Scope(value = ScopeType.SESSION)
public class PromissoryToBankAssurancePayrollBrowseBean extends BrowserBase<PromissoryToBankAssurancePayroll, PromissoryToBankAssurancePayrollFilterModel> implements PromissoryToBankAssurancePayrollBrowse<PromissoryToBankAssurancePayroll, PromissoryToBankAssurancePayrollFilterModel> {

	@In
    CalendarManager calendarManager;

    @Override
    public PromissoryToBankAssurancePayrollFilterModel newFilterModel() {
    	PromissoryToBankAssurancePayrollFilterModel fm = new PromissoryToBankAssurancePayrollFilterModel();
    ...
    @Observer("refreshBrowser:com.ut.tekir.entities.PromissoryToBankAssurancePayroll")
	...
	public void pdf() {
        ...
        execPdf("senet_banka_teminat_listesi", "Senet Banka Teminat Listesi", params);
	...
	public void detailedPdf() {
        ...
        execPdf("senet_banka_teminat_detay", "Senet Banka Teminat Detayi", params);
    }
