...
public class PurchaseInvoiceHomeBean extends EntityBase<Invoice> implements PurchaseInvoiceHome<Invoice> {
    ...
    public void createNew() {
        ...
        //entity.setReference(sequenceManager.getNewSerialNumber(SequenceType.REFERENCE_INVOICE_PURCHASE));
    ...
    public String save() {
        ...
        if (BaseConsts.SUCCESS.equals(res)) {
            ...
            events.raiseEvent("refreshBrowser:com.ut.tekir.entities.ShipmentNote");
        }
    ...
    public void createNewServiceLine() {
        ...
        item.getServiceItem().getAmount().setCurrency(BaseConsts.SYSTEM_CURRENCY_CODE);
    ...
    public void createNewShipmentLine() {
        ...
        //GUI
        InvoiceItemModel item = new InvoiceItemModel(ItemType.InvoiceShipmentItem);
        items.add(item);
    ...
    public void selectLine(Integer ix) {
        ...
        Object oo = o.getType() == ItemType.ServiceItem ? o.getService() : o.getProduct();
        if (oo != null) {
            o.getQuantity().setUnit(o.getType() == ItemType.ServiceItem ? o.getService().getUnit() : o.getProduct().getUnit());
            if (o.getType() == ItemType.ServiceItem) {
                o.setTaxRate(o.getService().getSellTax() != null ? o.getService().getSellTax().getRates().get(0).getRate() : BigDecimal.ZERO);
            } else {
                o.setTaxRate(o.getProduct().getBuyTax() != null ? o.getProduct().getBuyTax().getRates().get(0).getRate() : BigDecimal.ZERO);
            }
        }
    ...
    /**
     * Fatura satırlarını tek tek dolaşarak tüm fatura toplamlarını yeniden hesaplar...
     */
    ...
    public void selectShipmentNote(int ix) {
        //TODO: Burdaki seçim için kullnılan index değeri kontrol edilmeli. rowKey sadece aktif sayfanın indexini getiriyor olabilir...
    ...
    public void removeShipmentNote(int ix) {
        //TODO: Burda irsaliyeyi veri tabanından gerçekten silmeye kalmaz umarım...
	...
	public void print() {
		try {
			...
			if (!entity.getShipmentInvoice()) {
				jasperReport.printObjectToPDF( "irsaliyeli_alis_faturasi_" + entity.getReference(), "irsaliyeli_alis_faturasi", params, builder
					.getModel());
			} else {
				jasperReport.printObjectToPDF( "alis_faturasi_" + entity.getReference(), "alis_faturasi", params, builder
						.getModel());
			}
