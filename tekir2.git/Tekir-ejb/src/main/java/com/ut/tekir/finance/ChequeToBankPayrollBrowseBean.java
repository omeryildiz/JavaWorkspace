...
/**
 * Çek banka tahsilata gönderme bordrosu browse bileşenidir.
 * 
 * @author yigit
 */
@Stateful
@Name("chequeToBankPayrollBrowse")
@Scope(value = ScopeType.SESSION)
public class ChequeToBankPayrollBrowseBean extends BrowserBase<ChequeToBankPayroll, ChequeToBankPayrollFilterModel> implements ChequeToBankPayrollBrowse<ChequeToBankPayroll, ChequeToBankPayrollFilterModel> {

	@In
    CalendarManager calendarManager;

    @Override
    public ChequeToBankPayrollFilterModel newFilterModel() {
    	ChequeToBankPayrollFilterModel fm = new ChequeToBankPayrollFilterModel();
    ...
    @Observer("refreshBrowser:com.ut.tekir.entities.ChequeToBankPayroll")
