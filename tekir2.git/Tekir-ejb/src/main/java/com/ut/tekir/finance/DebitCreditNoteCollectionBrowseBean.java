 ...
 */
@Stateful
@Name("debitCreditNoteCollectionBrowse")
@Scope(ScopeType.SESSION)
public class DebitCreditNoteCollectionBrowseBean extends BrowserBase<DebitCreditNote, DebitCreditNoteFilterModel> implements CollectionBrowse<DebitCreditNote, DebitCreditNoteFilterModel> {
	...
	public void pdf() {
        ...
        execPdf("tahsilat_tediye_listesi", "Tahsilat Fişi Listesi", params);
	...
	public void detailedPdf() {
        ...
        execPdf("tahsilat_tediye_detay", "Tahsilat Fişi Detayi", params);
    }
}
