 ...
 */
@Stateful
@Name( "debitCreditVirementBrowse" )
@Scope(ScopeType.SESSION)
public class DebitCreditVirementBrowseBean extends BrowserBase<DebitCreditVirement, DefaultDocumentFilterModel> implements DebitCreditVirementBrowse<DebitCreditVirement, DefaultDocumentFilterModel>{
    ...
    @Observer("refreshBrowser:com.ut.tekir.entities.DebitCreditVirement")
	...
	public void pdf() {
        ...
        execPdf("virman_dekont_listesi", "Virman Dekont Listesi", params);
	...
	public void detailedPdf() {
        ...
        execPdf("virman_dekont_detay", "Virman Dekont Detayi", params);
    }
}
