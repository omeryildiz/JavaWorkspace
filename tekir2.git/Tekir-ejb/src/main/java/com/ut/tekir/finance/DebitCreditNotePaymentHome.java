 ...
 */
@Local
public interface DebitCreditNotePaymentHome<E> extends IEntityBase<E> {
    ...
    DebitCreditNote getDebitCreditNotePayment();

    void init();

    void manualFlush();

    void setDebitCreditNotePayment(DebitCreditNote payment);
