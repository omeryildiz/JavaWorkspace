...
public class PurchaseShipmentBrowseBean extends BrowserBase<ShipmentNote, ShipmentFilterModel> implements PurchaseShipmentBrowse<ShipmentNote, ShipmentFilterModel> {
