 ...
 */
@Stateful
@Name("promissoryCollectionAtBankPayrollBrowse")
@Scope(value = ScopeType.SESSION)
public class PromissoryCollectionAtBankPayrollBrowseBean extends BrowserBase<PromissoryCollectedAtBankPayroll, PromissoryCollectionAtBankPayrollFilterModel> implements PromissoryCollectionAtBankPayrollBrowse<PromissoryCollectedAtBankPayroll, PromissoryCollectionAtBankPayrollFilterModel> {

	@In
    CalendarManager calendarManager;

    @Override
    public PromissoryCollectionAtBankPayrollFilterModel newFilterModel() {
    	PromissoryCollectionAtBankPayrollFilterModel fm = new PromissoryCollectionAtBankPayrollFilterModel();
    ...
    @Observer("refreshBrowser:com.ut.tekir.entities.PromissoryCollectionAtBankPayroll")
	...
	public void pdf() {
        ...
        execPdf("senet_bordro__banka_tahsilatta_listesi", "Senet Bordro Banka Tahsilatta Listesi", params);
	...
	public void detailedPdf() {
        ...
        execPdf("senet_bordro_banka_tahsilatta_detay", "Senet Bordro Banka Tahsilatta Detayi", params);
    }
