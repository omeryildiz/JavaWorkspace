...
/**
 * Kasadan çek ödeme bordrosu browse bileşenidir.
 * 
 * @author sinan.yumak
 */
@Stateful
@Name("chequeToAccountPaymentPayrollBrowse")
@Scope(value = ScopeType.SESSION)
public class ChequeToAccountPaymentPayrollBrowseBean extends BrowserBase<ChequeToAccountPaymentPayroll, ChequeToAccountPaymentPayrollFilterModel> implements ChequeToAccountPaymentPayrollBrowse<ChequeToAccountPaymentPayroll, ChequeToAccountPaymentPayrollFilterModel> {

	@In
    CalendarManager calendarManager;

    @Override
    public ChequeToAccountPaymentPayrollFilterModel newFilterModel() {
    	ChequeToAccountPaymentPayrollFilterModel fm = new ChequeToAccountPaymentPayrollFilterModel();
    ...
    public DetachedCriteria buildCriteria() {
        ...
        DetachedCriteria crit = DetachedCriteria.forClass(ChequeToAccountPaymentPayroll.class);
		...
		.setResultTransformer(Transformers.aliasToBean(ChequeToAccountPaymentPayrollFilterModel.class));
    ...
    @Observer("refreshBrowser:com.ut.tekir.entities.ChequeToAccountPaymentPayroll")
