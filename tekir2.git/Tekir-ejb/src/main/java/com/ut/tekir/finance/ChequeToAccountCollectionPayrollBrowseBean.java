...
/**
 * Kasa çek tahsilata gönderme bordrosu home bileşenidir.
 * 
 * @author sinan.yumak
 */
@Name("chequeToAccountCollectionPayrollBrowse")
@Scope(value = ScopeType.SESSION)
public class ChequeToAccountCollectionPayrollBrowseBean extends BrowserBase<ChequeToAccountCollectionPayroll, ChequeToAccountCollectionPayrollFilterModel> implements ChequeToAccountCollectionPayrollBrowse<ChequeToAccountCollectionPayroll, ChequeToAccountCollectionPayrollFilterModel> {

	@In
    CalendarManager calendarManager;

    @Override
    public ChequeToAccountCollectionPayrollFilterModel newFilterModel() {
    	ChequeToAccountCollectionPayrollFilterModel fm = new ChequeToAccountCollectionPayrollFilterModel();
    ...
    @Observer("refreshBrowser:com.ut.tekir.entities.ChequeToAccountCollectionPayroll")
