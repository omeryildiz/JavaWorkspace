...
/**
 * Bankaya çek teminat bordrosu browse bileşenidir.
 * 
 * @author sinan.yumak
 */
@Stateful
@Name("chequeToBankAssurancePayrollBrowse")
@Scope(value = ScopeType.SESSION)
public class ChequeToBankAssurancePayrollBrowseBean extends BrowserBase<ChequeToBankAssurancePayroll, ChequeToBankAssurancePayrollFilterModel> implements ChequeToBankAssurancePayrollBrowse<ChequeToBankAssurancePayroll, ChequeToBankAssurancePayrollFilterModel> {

	@In
    CalendarManager calendarManager;

    @Override
    public ChequeToBankAssurancePayrollFilterModel newFilterModel() {
    	ChequeToBankAssurancePayrollFilterModel fm = new ChequeToBankAssurancePayrollFilterModel();
    ...
    /* (non-Javadoc)
	 * @see com.ut.tekir.finance.ChequeToBankAssurancePayrollBrowse#refreshResults()
	 */
    @Observer("refreshBrowser:com.ut.tekir.entities.ChequeToBankAssurancePayroll")
    ...
    /* (non-Javadoc)
	 * @see com.ut.tekir.finance.ChequeToBankAssurancePayrollBrowse#pdf()
	 */
	...
	public void pdf() {
        ...
        execPdf("çek_banka_teminat_listesi", "Çek Banka Teminat Listesi", params);

    }

    /* (non-Javadoc)
	 * @see com.ut.tekir.finance.ChequeToBankAssurancePayrollBrowse#detailedPdf()
	 */
    @SuppressWarnings("unchecked")
	public void detailedPdf() {
        ...
        execPdf("çek_banka_teminat_detay", "Çek Banka Teminat Detayi", params);
    }
