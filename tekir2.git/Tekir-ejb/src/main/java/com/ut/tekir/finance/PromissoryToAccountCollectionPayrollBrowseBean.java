...
/**
 * Kasaya senet tahsilatı browse bileşenidir.
 * 
 * @author sinan.yumak
 */
@Stateful
@Name("promissoryToAccountCollectionPayrollBrowse")
@Scope(value = ScopeType.SESSION)
public class PromissoryToAccountCollectionPayrollBrowseBean extends BrowserBase<PromissoryToAccountCollectionPayroll, PromissoryToAccountCollectionPayrollFilterModel> implements PromissoryToAccountCollectionPayrollBrowse<PromissoryToAccountCollectionPayroll, PromissoryToAccountCollectionPayrollFilterModel> {

	@In
    CalendarManager calendarManager;

    @Override
    public PromissoryToAccountCollectionPayrollFilterModel newFilterModel() {
    	PromissoryToAccountCollectionPayrollFilterModel fm = new PromissoryToAccountCollectionPayrollFilterModel();
    ...
    public DetachedCriteria buildCriteria() {
		...
		.setResultTransformer(Transformers.aliasToBean(PromissoryToAccountCollectionPayrollFilterModel.class));
    ...
    @Observer("refreshBrowser:com.ut.tekir.entities.PromissoryToAccountCollectionPayroll")
	...
	public void pdf() {
        ...
        execPdf("cek_kasa_tahsil_bordro_listesi", "Cek Kasa Tahsil Bordro Listesi", params);
	...
	public void detailedPdf() {
        ...
        execPdf("cek_kasa_tahsil_bordro_listesi_detay", "Cek Kasa Tahsil Bordro Detayi", params);
    }
