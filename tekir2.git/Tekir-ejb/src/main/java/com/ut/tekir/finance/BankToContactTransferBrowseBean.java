 ...
 */
@Stateful
@Name("bankToContactTransferBrowse")
@Scope(ScopeType.SESSION)
public class BankToContactTransferBrowseBean extends BrowserBase<BankToContactTransfer, BankToContactTransferFilterModel> implements BankToContactTransferBrowse<BankToContactTransfer, BankToContactTransferFilterModel> {

    @In
    CalendarManager calendarManager;

    @Override
    public BankToContactTransferFilterModel newFilterModel() {
        BankToContactTransferFilterModel fm = new BankToContactTransferFilterModel();
	...
	public void pdf() {
       ...
       // execPdf("depo_sevk_listesi", "Depo Sevk Listesi", params);
        execPdf("banka_cari_transfer_listesi", "Banka Cari Transfer Listesi", params);
    }
	...
	public void detailedPdf() {
		...
		*/
        ...
        execPdf("banka_cari_transfer_detay", "Banka Cari Transfer Detay", params);
