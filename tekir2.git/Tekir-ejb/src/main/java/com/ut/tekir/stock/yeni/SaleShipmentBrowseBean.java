...
public class SaleShipmentBrowseBean extends BrowserBase<TekirShipmentNote, ShipmentFilterModel> implements SaleShipmentBrowse<TekirShipmentNote, ShipmentFilterModel> {
    ...
    @Observer("refreshBrowser:com.ut.tekir.entities.TekirShipmentNote")
