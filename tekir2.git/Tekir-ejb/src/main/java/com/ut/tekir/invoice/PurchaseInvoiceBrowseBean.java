...
public class PurchaseInvoiceBrowseBean extends BrowserBase<Invoice, InvoiceFilterModel> implements PurchaseInvoiceBrowse<Invoice, InvoiceFilterModel> {
	...
	public void pdf() {
        ...
        execPdf("fatura_listesi", "Alıs Fatura Listesi", params);
	...
	public void detailedPdf() {
        ...
        execPdf("alis-satis-fatura", "Alıs Fatura Detayi", params);
    }
}
