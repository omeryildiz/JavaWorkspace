...
/**
 *
 * Float bir değer için sadece integer kısmını olan bir coverter.
 * 
 * TODO: Geliştirilmeye devam edilecek
 * @author haky
 */
@Name("floatConverter")
@BypassInterceptors
@Converter
public class FloatConverter implements javax.faces.convert.Converter {
    ...
    public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
        ...
        String s = String.format(locale, "%,.2f", f);
        return s;
    }
}
