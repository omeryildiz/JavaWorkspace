 ...
 * @author burak
 */
@Name("chequePaymentToAccount")
@Scope(ScopeType.CONVERSATION)
public class ChequePaymentToAccountBean extends BrowserBase<Cheque, ChequeFilterModel> implements ChequePaymentToAccount<Cheque, ChequeFilterModel>{
    	...
    	try {
			...
			for(Cheque cheque : getChequeList()){
				...
				if (cheque.getChecked()) {
					...
					cpm.setDocumentType(DocumentType.ChequePayment);
					counter++;
