...
@Local
public interface PromissoryChangeLastStatus<E, F> extends IBrowserBase<E, F>{
	...
	Boolean getIsClientPromissory();

	void setIsClientPromissory(Boolean isClientPromissory);
	
	String changeLastStatus();
	
	void setNewStatusOfPromissory(PromissoryNote promissory);
