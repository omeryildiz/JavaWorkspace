 ...
 */
@Stateful
@Name("bankToAccountTransferHome")
@Scope(value = ScopeType.CONVERSATION)
public class BankToAccountTransferHomeBean extends EntityBase<BankToAccountTransfer> implements BankToAccountTransferHome<BankToAccountTransfer> {
    ...
    @Out(required = false) 
    public BankToAccountTransfer getBankToAccountTransfer() {
        return getEntity();
    }

    @In(required = false)
    public void setBankToAccountTransfer(BankToAccountTransfer bankToAccountTransfer) {
        setEntity(bankToAccountTransfer);
    }

    @Override
    public void createNew() {
        log.debug("Yeni BankToAccountTransfer");
        ...
        entity.setSerial(sequenceManager.getNewSerialNumber( SequenceType.SERIAL_BANKTO_ACCOUNT_TRANSFER));
    ...
    public String save() {
    	...
    	try {
	        ...
	        if( BaseConsts.SUCCESS.equals(res) ){
	            bankTxnAction.saveBankToAccount(entity);
	            accountTxnAction.saveBankToAccountTransfer(entity);
	        }
    ...
    public String delete() {
        ...
        bankTxnAction.deleteBankToAccount(entity);
        accountTxnAction.deleteBankToAccountTransfer(entity);
