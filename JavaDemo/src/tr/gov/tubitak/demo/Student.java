...
public class Student {
	...
	public Student() {
		System.out.println("Ýlk constructor çalýþtý");
	}
	...
	public Student(String name, int age)
	{
		...
		this(name);
		//this.name = name; zaten tanýmlandýðý için this(name) kullanabiliriz. Bu þekilde artan bir þekilde constructor kullanýlabilir.
		System.out.println("Ýkinci constructor çalýþtý");
		this.age = age;
	}
	public Student(String name)
	{
		System.out.println("Üçüncü constructor çalýþtý");
		this.name = name;
	}
	...
	public void doHomework() {
		System.out.println(name + " ödevini yapýyor.");
	}
	...
	// Bu özellik istenildiði kadar parametreyi toplamayý saðlar
