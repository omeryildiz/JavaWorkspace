...
//		System.out.println("");
		...
		CollectionFrameworkSamples.cizgiCek();
		String text = "þakir aðlamasaydý çok gülerdi.".toUpperCase(new Locale("tr", "TR"));
		System.out.println(text);
		System.out.println(text.substring(1, 5));
		
		Student omer = new Student("Ömer YILDIZ",25);
		Student yunus = new Student("Yunus Seçkin");
